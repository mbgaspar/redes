...
const char* SSID = "nomedarede"; //Seu SSID da Rede WIFI
const char* PASSWORD = "xxxxx"; // A Senha da Rede WIFI
const char* MQTT_SERVER = "test.mosquitto.org"; //Broker do Mosquitto.org
const char* MQTT_SERVER2 = "broker.mqttdashboard.com";
...
void setup(void) {
  Serial.begin(115200);
  setupWIFI(); 
  MQTT.setServer(MQTT_SERVER2, 1883);
}
void reconectar() {
...
void loop(void) {
  ...
  if (now - lastMsg > 2000) {
    ...
    MQTT.publish("tchatchatcha/tartinedemerde", msg);
  }
}
